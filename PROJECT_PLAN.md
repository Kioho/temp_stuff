...
| --- | --- | --- |
| 2026-05-01 | Keep the bottom CTA on `om-oss.html` focused on the store location. | Removed the secondary `Pre-Opening Event` link while keeping `Kom förbi på Eriksgatan 18` and `Hitta Hit`. |
